...
const RevenuesProjectPayment = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://active-interior-f9hq.onrender.com/accounts`)
            .then(res => res.json())
            .then(data => {
                setRevenue(data?.project_payment);
                setLoading(false);
            })
                    ...
                    <table className='col-span-3'>
                        <thead className='border'>
                            <tr>
                                ...
                                <th className='border border-[#FFBF00] px-5 py-2 text-[#FFBF00]'>Project Name</th>
                                ...
                                <th className='border border-[#FFBF00] px-5 py-2 text-[#FFBF00]'>Total Received</th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                    ...
                                    sortedData?.sort((a, b) => new Date(b.date) - new Date(a.date)).map((tr, index) => {
                                        return (
                                            <tr key={index} className='border'>
                                                ...
                                                <td className='border border-[#FFBF00] px-5 py-2'>{tr?.project_name}</td>
                                                ...
                                                <td className='border border-[#FFBF00] px-5 py-2'>{tr?.total_received_amount}</td>
                                            </tr>
                                        )
                                    }) :
...
export default RevenuesProjectPayment;