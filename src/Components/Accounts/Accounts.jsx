    ...
    return (
        <div className='grid grid-cols-12 gap-5 h-[85vh]'>
            <div className='flex flex-col shadow-lg shadow-amber-400 col-span-2 rounded-2xl overflow-scroll scrollbar-handle'>
                ...
                <div className='py-7 shadow-md shadow-amber-400 text-center text-lg'>
                    <NavLink className={({ isActive }) => isActive ? 'text-[#FFBF00]' : 'hover:text-[#FFBF00] duration-300'} to={'/construction/accounts/cash_in'}>Cash In</NavLink>
                </div>
                <div className='py-7 shadow-md shadow-amber-400 text-center text-lg'>
                    <NavLink className={({ isActive }) => isActive || location.pathname.includes('/construction/accounts/revenues') ? 'text-[#FFBF00]' : 'hover:text-[#FFBF00] duration-300'} to={'/construction/accounts/revenues/project_payment'}>Revenues</NavLink>
                </div>
                <div className='py-7 shadow-md shadow-amber-400 text-center text-lg'>
                ...
                <div className='py-7 shadow-md shadow-amber-400 text-center text-lg'>
                    <NavLink className={({ isActive }) => isActive || location.pathname.includes('/construction/accounts/expenses') ? 'text-[#FFBF00]' : 'hover:text-[#FFBF00] duration-300'} to={'/construction/accounts/expenses/material_purchase'}>Expenses</NavLink>
                </div>
            </div>
