    ...
    const handleSubmit = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://active-interior-f9hq.onrender.com/office_expenses`, {
                    method: 'PATCH',
                    headers: {
    ...
    return (
        <div className='h-full'>
            ...
            <div className={`p-7 ${loading ? 'hidden' : ''}`}>
                ...
                <h1 className='text-xl text-[#FFBF00] text-center font-semibold'>Office Expenses</h1>
                <div>
...
export default CashOutOfficeExpenses;