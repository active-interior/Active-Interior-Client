...
const ExpensesPersonalExpenses = () => {
    ...
    useEffect(() => {
        ...
        fetch(`https://active-interior-f9hq.onrender.com/accounts`)
            .then(res => res.json())
            .then(data => {
                setExpense(data?.personal_expenses);
                setLoading(false);
            })
    }, [])
                    ...
                    <table className='col-span-3'>
                        <thead className='border'>
                            <tr>
                                ...
                                <th className='border border-[#FFBF00] px-5 py-2 text-[#FFBF00]'>Purpose</th>
                                <th className='border border-[#FFBF00] px-5 py-2 text-[#FFBF00] w-60'>Payment Method</th>
...
export default ExpensesPersonalExpenses;