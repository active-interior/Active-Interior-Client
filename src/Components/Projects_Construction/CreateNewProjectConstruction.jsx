...
const CreateNewProjectConstruction = () => {
                ...
                <div className='grid grid-cols-2 gap-x-10 gap-y-5'>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        ...
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={projectSL} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Name</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={projectName} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Location</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={projectLocation} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Survey date</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={surveyDate} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Owner Name</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={ownerName} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Owner Mobile Number</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={ownerNumber} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Officer Name</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={officerName} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Officer Mobile Number</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={officerNumber} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Supervisor Name</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={supervisorName} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Supervisor Mobile Number</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={supervisorNumber} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Related Person Name</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={prpName} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                        <p className='text-[#FFBF00]'>Project Related Person Mobile Number</p>
                        <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                            <input ref={prpNumber} type="text" className='outline-none w-full' />
                        </div>
                    </div>
                    <div className='flex flex-col items-start w-full gap-2 mt-4'>
                    ...
                    <div className='grid grid-cols-2 gap-8'>
                        <div className='flex flex-col items-start w-full gap-2 mt-4'>
                            ...
                            <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                                <input ref={foundationNumber} type="text" className='outline-none w-full' />
                            </div>
                        </div>
                        <div className='flex flex-col items-start w-full gap-2 mt-4'>
                            <p className='text-[#FFBF00]'>Roofing Number</p>
                            <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                                <input ref={roofingNumber} type="text" className='outline-none w-full' />
                            </div>
                        </div>
                    </div>
                    <div className='grid grid-cols-2 gap-8'>
                        <div className='flex flex-col items-start w-full gap-2 mt-4'>
                            ...
                            <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                                <input ref={floorNumber} type="text" className='outline-none w-full' />
                            </div>
                        </div>
                        <div className='flex flex-col items-start w-full gap-2 mt-4'>
                            <p className='text-[#FFBF00]'>Project Budget</p>
                            <div className='px-3 border-2 border-[#FFBF00] rounded-xl h-10 shadow-md shadow-[#FFBF00] w-full flex'>
                                <input ref={projectBudget} type="number" className='outline-none w-full' />
                            </div>
                        </div>
                    </div>
                </div>
                <div className='flex flex-col items-start w-full gap-2 mt-4'>
                    ...
                    <div className='w-full flex items-center gap-5'>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Bricks" name="Bricks" value="Bricks" />
                            <label for="Bricks">Bricks</label><br />
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Sand" name="Sand" value="Sand" />
                            <label for="Sand">Sand</label><br />
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Cement" name="Cement" value="Cement" />
                            <label for="Cement">Cement</label><br />
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Rods" name="Rods" value="Rods" />
                            <label for="Rods">Rods</label><br />
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Stones" name="Stones" value="Stones" />
                            <label for="Stones">Stones</label><br />
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Silicone" name="Silicone" value="Silicone" />
                            <label for="Silicone">Silicone</label><br />
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Electrical_Items" name="Electrical_Items" value="Electrical Items" />
                            <label for="Electrical_Items">Electrical Items</label><br />
                        </div>
                        <div className='flex items-center gap-2'>
                            <input onChange={handleUsedMaterialsCheckbox} type="checkbox" id="Sanitary_Items" name="Sanitary_Items" value="Sanitary Items" />
...
export default CreateNewProjectConstruction;